          ...
          <Grid item xs={12} md={7}>
            ...
            <div className="footer-social-parent" style={{ display: knownSocialUrls.length > 0 ? undefined : 'none' }}>
              ...
              <div className="footer-social-child footer-social-child-2">
                <a className="footer-social-button footer-social-btn-2" href={socialLinks.instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <div className="footer-social-child footer-social-child-4">
                <a className="footer-social-button footer-social-btn-4" href={socialLinks.facebookUrl} target="_blank" rel="noopener noreferrer" aria-label="Facebook">
